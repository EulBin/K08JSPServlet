...
내용을 모두 채운 후 작성(submit)할때는 Post 방식으로 전송하므로 doPost()가
요청을 받아 처리한다.
*/
public class WriteController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		//application 내장객체를 통해 web.xml에 동록된 초기화 파라미터를 얻어온다.
		...
		if (mr == null) {
			JSFunction.alertLocation(resp, "제한 용량을 초과 or 디렉토리 경로를 확인하세요.", 
					"../mvcboard/write.do");
			return;
		}
