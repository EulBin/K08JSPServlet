...
public class EditController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//web.xml에 기술한 건텍스트 초기화 파라미터를 얻어온다.
		...
		MultipartRequest mr = FileUtil.uploadFile(req, saveDirectory,
				maxPostSize);
		if (mr == null) {
			JSFunction.alertBack(resp, "제한 용량을 초과 or 디렉토리 경로를 확인하세요.");
			return;
		}
		...
		/*
		패스워드의 경우 인증이 완료되었을 때 session영역에 저장해 두었다.
		따라서 update쿼리 실행시 사용하기 위해 session 영역에서 속성값을 가져온다.
